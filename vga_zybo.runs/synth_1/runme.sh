...
HD_PWD='D:/VHDL/zybo/vga_zybo/vga_zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_controller_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_controller_top.tcl
