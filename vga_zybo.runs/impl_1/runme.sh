...
HD_PWD='D:/VHDL/zybo/vga_zybo/vga_zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_controller_top.tcl -notrace
