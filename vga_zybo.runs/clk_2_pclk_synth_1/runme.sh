...
HD_PWD='D:/VHDL/zybo/vga_zybo/vga_zybo.runs/clk_2_pclk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_2_pclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_2_pclk.tcl
